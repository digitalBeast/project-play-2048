...
from selenium import webdriver   #SEARCH "CMD" in window to install selenium
from selenium.webdriver.common.keys import Keys   #allows you to use the UP,RIGHT,DOWN,LEFT keys


def play2048( times ):
    
    browser = webdriver.Firefox()  #uses firefox as a website to use the URL
    browser.get('https://gabrielecirulli.github.io/2048/')  #the website of the game to find the high score
